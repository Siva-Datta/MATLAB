voices = string({'Morning1.wav','Morning2.wav','Morning3.wav','Lunch1.wav','Lunch2.wav','Lunch3.wav','morning1p.wav','morning2p.wav','morning3p.wav','Lunchp1.wav','Lunchp2.wav','Lunchp3.wav'});
%rectangular window
